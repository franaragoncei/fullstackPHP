    ...
    <form action="recogida.php" method="post">
        ...
        <div>
            ...
            <select name="nacido" id="nacido">
                <option value="Malaga" <?php if($_POST['nacido'] == 'Malaga'){ echo 'selected';} ?>>Málaga</option>
                <option value="Sevilla" <?php if($_POST['nacido'] == 'Sevilla'){ echo 'selected';} ?>>Sevilla</option>
            </select>
            </div>
            <div>
                <span>Aficiones: </span>
